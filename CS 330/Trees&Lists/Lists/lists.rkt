...
(define thePoolGuy(make-person "Sergio" 1984 'gr whoknows whoknows))
(define ben(make-person "Ben" 2001 'gr jose thePoolGuy))
(define jessica(make-person "jessica" 2001 'gr whoknows whoknows))
(define John(make-person "john" 2012 'gr jessica ben))
